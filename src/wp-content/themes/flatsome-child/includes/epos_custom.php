...
{
  if (is_page('whatsapp-loyalty-program') || is_page('payment-soundbox') || is_page('marketing-ai-page') || is_page('rewards-loyalty-programme') || is_page('ecommerce-web-development') ||  is_home()) {
    $version = time();
...
add_action('after_setup_theme', function () {
  ...
  add_action('wp_enqueue_scripts', 'custom_flatsome_add_icons_css', 150);
}, 20);
